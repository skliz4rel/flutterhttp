...
import 'package:flutterhttp/http/api_service.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _getByID(String id) async {
    Post post = await apiService.getPostById(id);
    print(post.toJson());
  }
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                print("The get post button has been clicked");
            ...
            ElevatedButton(
              onPressed: () {
                print("Get Post button was clicked");
